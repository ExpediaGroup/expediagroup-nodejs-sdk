...
export class TravelProduct {
     ...
     */
    @JsonProperty({ name: 'inventory_type' })
     ...
     */
    @JsonProperty({ name: 'inventory_source' })
     ...
     */
    @JsonProperty({ name: 'travelers_references' })
    travelersReferences?: Array<string>
    /**
     ...
     */
    @JsonProperty({ name: 'pay_later' })
    payLater?: boolean

    public constructor(travelProduct: TravelProductProperties) {
        this.price = travelProduct.price
        this.inventoryType = travelProduct.inventoryType
        this.inventorySource = travelProduct.inventorySource
        this.travelersReferences = travelProduct.travelersReferences
        this.payLater = travelProduct.payLater
    }
}

export type TravelProductInventorySourceEnum = 'MERCHANT' | 'AGENCY'

export interface TravelProductProperties {
    price: Amount
    inventoryType: string
    inventorySource: TravelProductInventorySourceEnum
    travelersReferences?: Array<string>

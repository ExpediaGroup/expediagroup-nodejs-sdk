...
export class RetryableOrderPurchaseScreenFailure {
    /**
    ...
    code: RetryableOrderPurchaseScreenFailureCodeEnum
    /**
...
export type RetryableOrderPurchaseScreenFailureCodeEnum =
    | 'UNAUTHORIZED'
    | 'FORBIDDEN'
    | 'NOT_FOUND'
...
export interface RetryableOrderPurchaseScreenFailureProperties {
    code: RetryableOrderPurchaseScreenFailureCodeEnum
    message: string
}

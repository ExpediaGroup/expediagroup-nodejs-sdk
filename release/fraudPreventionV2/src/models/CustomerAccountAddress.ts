...
export class CustomerAccountAddress {
    @JsonProperty({ name: 'address_type' })
    addressType?: CustomerAccountAddressAddressTypeEnum
    /**
    ...
    public constructor(
        ...
        this.addressLine2 = customerAccountAddress.addressLine2
        this.city = customerAccountAddress.city
        this.state = customerAccountAddress.state
        this.zipCode = customerAccountAddress.zipCode
        this.countryCode = customerAccountAddress.countryCode
    }
}

export type CustomerAccountAddressAddressTypeEnum = 'HOME' | 'WORK'

export interface CustomerAccountAddressProperties {
    addressType?: CustomerAccountAddressAddressTypeEnum
    addressLine1: string
    addressLine2?: string
    city: string

[API](../../index.md) > [models](../index.md) > Cruise
...
| :------ | :------ | :------ | :------ | :------ | :------ |
| `public` | `arrivalTime` | `Date` | Local date and time of arrival from original arrival location, in ISO-8601 date and time format `yyyy-MM-ddTHH:mm:ss.SSSZ`. | - | models/Cruise.ts:36 |
| `public` | `departureTime` | `Date` | Local date and time of departure from original departure location, in ISO-8601 date and time format `yyyy-MM-ddTHH:mm:ss.SSSZ`. | - | models/Cruise.ts:31 |
| `public` | `disembarkationPort` | `string` | The cruise\'s final destination. | - | models/Cruise.ts:46 |
| `public` | `embarkationPort` | `string` | Location from where cruise will depart. | - | models/Cruise.ts:41 |
...
| `public` | `shipName` | `string` | Name of the cruise ship. | - | models/Cruise.ts:51 |
...
| `readonly` | `type` | `"CRUISE"` | - | - | models/Cruise.ts:54 |

[API](../../index.md) > [models](../index.md) > DirectDebit
...
| `readonly` | `method` | `"DIRECT_DEBIT"` | - | - | models/DirectDebit.ts:50 |
...
| `public` | `routingNumber` | `string` | A code that identifies the financial institution for a specific bank account. | - | models/DirectDebit.ts:34 |
| `public` | `telephones` | [`Telephone`](Telephone.md)[] | Telephone(s) associated with direct debit payment provider. | - | models/DirectDebit.ts:47 |

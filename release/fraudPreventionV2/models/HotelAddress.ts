...
export class HotelAddress {
    ...
    addressType?: HotelAddressAddressTypeEnum
    /**
    ...
    public constructor(hotelAddress: HotelAddressProperties) {
        this.addressType = hotelAddress.addressType
        this.addressLine1 = hotelAddress.addressLine1
        this.addressLine2 = hotelAddress.addressLine2
        this.city = hotelAddress.city
        this.state = hotelAddress.state
        this.zipCode = hotelAddress.zipCode
        this.countryCode = hotelAddress.countryCode
    }
}

export type HotelAddressAddressTypeEnum = 'HOME' | 'WORK'

export interface HotelAddressProperties {
    addressType?: HotelAddressAddressTypeEnum
    addressLine1: string
    addressLine2?: string
    city: string

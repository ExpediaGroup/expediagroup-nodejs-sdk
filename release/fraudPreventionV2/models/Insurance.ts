...
export class Insurance extends TravelProduct {
    @JsonProperty('type')
    readonly type = 'INSURANCE'

    public constructor(insurance: InsuranceProperties) {
        super({
...
export interface InsuranceProperties extends TravelProductProperties {}

...
export class PaymentOperation {
    ...
    public constructor(paymentOperation: PaymentOperationProperties) {
        this.id = paymentOperation.id
        this.amount = paymentOperation.amount
        this.outcome = paymentOperation.outcome
    }
}

export interface PaymentOperationProperties {
    id?: string
    amount?: Amount
    outcome?: PaymentOutcome
}
